...
export function ChangelogDialog({ isOpen, onClose }: ChangelogDialogProps) {
  return (
    <FullScreenDialog isOpen={isOpen} onClose={onClose}>
      <h2 className="text-2xl font-bold text-gray-800 mb-2">更新日志</h2>
      <p className="text-xs text-gray-400 mb-8">总开发时间：9.64 hr</p>
      ...
      <div className="space-y-10 text-sm text-gray-600">
        ...
        <section>
          <div className="flex items-center gap-3 mb-3">
            <span className="px-2.5 py-1 rounded-full bg-gray-100 text-gray-600 text-xs font-semibold">v1.3.1</span>
            <span className="text-gray-300 text-xs ml-auto">2026-04-15 21:00</span>
          </div>
          <ul className="list-disc pl-5 space-y-1.5">
        ...
        <section>
          <div className="flex items-center gap-3 mb-3">
            <span className="px-2.5 py-1 rounded-full bg-gray-100 text-gray-600 text-xs font-semibold">v1.3.0</span>
            <span className="text-gray-300 text-xs ml-auto">2026-04-15 20:30</span>
          </div>
          <ul className="list-disc pl-5 space-y-1.5">
        ...
        <section>
          <div className="flex items-center gap-3 mb-3">
            <span className="px-2.5 py-1 rounded-full bg-gray-100 text-gray-600 text-xs font-semibold">v1.2.0</span>
            <span className="text-gray-300 text-xs ml-auto">2026-04-15 19:30</span>
          </div>
          <ul className="list-disc pl-5 space-y-1.5">
        ...
        <section>
          <div className="flex items-center gap-3 mb-3">
            <span className="px-2.5 py-1 rounded-full bg-gray-100 text-gray-600 text-xs font-semibold">v1.1.3</span>
            <span className="text-gray-300 text-xs ml-auto">2026-04-15 18:44</span>
          </div>
          <ul className="list-disc pl-5 space-y-1.5">
        ...
        <section>
          <div className="flex items-center gap-3 mb-3">
            <span className="px-2.5 py-1 rounded-full bg-gray-100 text-gray-600 text-xs font-semibold">v1.1.2</span>
            <span className="text-gray-300 text-xs ml-auto">2026-04-15 18:06</span>
          </div>
          <ul className="list-disc pl-5 space-y-1.5">
        ...
        <section>
          <div className="flex items-center gap-3 mb-3">
            <span className="px-2.5 py-1 rounded-full bg-gray-100 text-gray-600 text-xs font-semibold">v1.1.1</span>
            <span className="text-gray-300 text-xs ml-auto">2026-04-15 17:58</span>
          </div>
          <ul className="list-disc pl-5 space-y-1.5">
        ...
        <section>
          <div className="flex items-center gap-3 mb-3">
            <span className="px-2.5 py-1 rounded-full bg-gray-100 text-gray-600 text-xs font-semibold">v1.1.0</span>
            <span className="text-gray-300 text-xs ml-auto">2026-04-15 17:51</span>
          </div>
          <ul className="list-disc pl-5 space-y-1.5">
        ...
        <section>
          <div className="flex items-center gap-3 mb-3">
            <span className="px-2.5 py-1 rounded-full bg-gray-100 text-gray-600 text-xs font-semibold">v1.0.4</span>
            <span className="text-gray-300 text-xs ml-auto">2026-04-15 10:48</span>
          </div>
          <ul className="list-disc pl-5 space-y-1.5">
        ...
        <section>
          <div className="flex items-center gap-3 mb-3">
            <span className="px-2.5 py-1 rounded-full bg-gray-100 text-gray-600 text-xs font-semibold">v1.0.3</span>
            <span className="text-gray-300 text-xs ml-auto">2026-04-14 19:02</span>
          </div>
          <ul className="list-disc pl-5 space-y-1.5">
        ...
        <section>
          <div className="flex items-center gap-3 mb-3">
            <span className="px-2.5 py-1 rounded-full bg-gray-100 text-gray-600 text-xs font-semibold">v1.0.2</span>
            <span className="text-gray-300 text-xs ml-auto">2026-04-14 18:31</span>
          </div>
          <ul className="list-disc pl-5 space-y-1.5">
        ...
        <section>
          <div className="flex items-center gap-3 mb-3">
            <span className="px-2.5 py-1 rounded-full bg-gray-100 text-gray-600 text-xs font-semibold">v1.0.1</span>
            <span className="text-gray-300 text-xs ml-auto">2026-04-14 18:25</span>
          </div>
          <ul className="list-disc pl-5 space-y-1.5">
        ...
        <section>
          <div className="flex items-center gap-3 mb-3">
            <span className="px-2.5 py-1 rounded-full bg-amber-100 text-amber-700 text-xs font-semibold">β1.0.0</span>
            <span className="text-gray-400 text-xs">Beta 初始版本</span>
            <span className="text-gray-300 text-xs ml-auto">2026-04-14 18:11</span>
          </div>
          <ul className="list-disc pl-5 space-y-1.5">
            <li>初始版本发布</li>
